  ...
  <section class="hero" id="home">
    ...
    <div class="container hero-grid">
      <div>
        ...
        <p>
          We develop influencer and brand collaboration platforms for agencies, creators, communities, and brands that
          need campaign management, creator discovery, proposals, contracts, payments, and performance analytics.
        </p>
              ...
              <aside class="right-panel">
                ...
                <div class="suggestion-list">
                  <div class="suggestion"><span class="avatar small purple"></span>
                    <div><strong>Alya Beauty</strong><span>Nano Creator</span></div>
                  </div>
                  <div class="suggestion"><span class="avatar small orange"></span>
                    <div><strong>Rafi Tech</strong><span>Gadget Reviewer</span></div>
                  </div>
                  <div class="suggestion"><span class="avatar small green"></span>
                    <div><strong>Naya Travel</strong><span>Lifestyle Creator</span></div>
                  </div>
                  <div class="suggestion"><span class="avatar small"></span>
                    <div><strong>Dito Food</strong><span>Content Creator</span></div>
                  </div>
                </div>
              </aside>
            </div>
    ...
    <div class="container">
      <div class="section-header center">
        ...
        <p class="section-desc">
          From creator discovery to campaign briefs, proposal workflows, content approvals, contracts, payments,
          tracking links, and reporting, the platform can be customized for agencies, brands, and creator networks.
        </p>
      </div>
      ...
      <div class="feature-grid">
        <article class="feature-card">
          ...
          <p>Discover influencers by niche, audience, engagement, location, rate card, portfolio, and brand-fit scoring.
          </p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">📣</div>
          <h3>Campaign Briefs</h3>
          <p>Create campaign briefs, invite creators, manage proposals, set deliverables, deadlines, and campaign goals.
          </p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">🧾</div>
          <h3>Media Kit & Portfolio</h3>
          <p>Showcase creator profiles, audience insights, past collaborations, content samples, and pricing packages.
          </p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">✅</div>
          <h3>Content Approval</h3>
          <p>Review drafts, approve campaign content, request revisions, and track submission status in one workflow.
          </p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">💳</div>
        ...
        <article class="feature-card">
          ...
          <p>Monitor reach, clicks, engagement, conversions, ROI, campaign progress, and creator performance reports.
          </p>
        </article>
      </div>
    </div>
    ...
    <div class="container split-grid">
      ...
      <div>
        <div class="section-header">
          ...
          <p class="section-desc">
            The platform can be developed as a complete collaboration product or module-by-module based on your agency
            workflow, brand partnership model, and creator network.
          </p>
        </div>
        ...
        <div class="module-list">
          <div class="module-item">
            ...
            <div>
              ...
              <p>Registration, login, creator profiles, brand accounts, media kits, portfolios, rate cards,
                verification, and permissions.</p>
            </div>
          </div>
          <div class="module-item">
            ...
            <div>
              ...
              <p>Create briefs, invite creators, submit proposals, negotiate offers, assign deliverables, and manage
                deadlines.</p>
            </div>
          </div>
          <div class="module-item">
            ...
            <div>
              ...
              <p>Upload drafts, collect feedback, approve content, manage revisions, track deliverables, and organize
                campaign assets.</p>
            </div>
          </div>
          <div class="module-item">
            ...
            <div>
              ...
              <p>Track agreements, invoices, payment milestones, campaign engagement, link clicks, conversions, ROI, and
                creator performance.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="pricing" id="contact">
    <div class="container">
      <div class="cta-box">
        ...
        <p>
          Build a custom influencer-brand collaboration platform with creator marketplace, campaign management, approval
          workflows, contracts, payments, tracking, and analytics dashboard.
        </p>
